# Linux Development practicum on CMC MSU 2023


### About
[Course info](http://uneex.ru/LecturesCMC/LinuxApplicationDevelopment2023)
...
* [Отладка](./04_Debugging)
* [Регулярные выражения](./05_Regexps)
* [Трассировка и защита памяти](./06_TracingFencing)
* [Сборочные зависимости и адаптация к окружению](./07_Environmental)
* [Интернационализация и локализация](./08_I18n)
* [Сторонние исходники](./09_PatchDiff)
* [Тестирование](./10_Testing)
